...
public class AnimeRepository {
    ...
    public static List<Anime> findByName(String name) {
        log.info("find animes by name '{}'", name);
    ...
    public static void delete(int id) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            ps.execute();
            log.info("Delete anime '{}' in the database", id);
        } catch (SQLException e) {
    ...
    private static PreparedStatement createPreparedStatementUpdate(Connection conn, Anime anime)
            throws SQLException {
