...
class PersonServiceTest {
    ...
    void isAdult_ReturnFalse_WhenAgeIsLowerThan() {
    ...
    void filterRemovingNotAdult_ReturnListWithAdultOnly_WhenListOfPersonWithAdultIsPassed() {
        ...
        List<Person> listPersons = List.of(person1, person2, person3);
        Assertions.assertEquals(2, personService.filterRemovingNotAdult(listPersons).size());
    }
}